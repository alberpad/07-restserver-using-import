...
app.get('/usuario', verificaToken, function(req: any, res: any) {
...
app.post('/usuario', [verificaToken, verificaAdminRole], function(req: any, res: any) {
  let body = req.body;
...
app.put('/usuario/:id', [verificaToken, verificaAdminRole], function(req: any, res: any) {
...
app.delete('/usuario/:id', [verificaToken, verificaAdminRole], function(req: any, res: any) {
  let id = req.params.id;
  //Eliminación física
